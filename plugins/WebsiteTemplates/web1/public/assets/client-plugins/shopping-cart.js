...
async function paynow() {
	...
	console.log("Invoice response",invoice)
  	...
  	await axios({
	   ...
	   data : {
			   "settingId" : "1c19e2dc-fb21-46cf-83dd-172df2e52b9d",
			   "gateway": "stripe",
			   "id" : invoice.data.InvoiceID,
			   "amount" :400,
			   "cname" : "John Doe",
			   "value": "59",
          "user" : "webmaster1@gmail.com",
			   "type": cardType,						//change
			   "cardNumber": "4242424242424242",				//change
...
async function addInvoice() {
	...
	await axios({
		  ...
		  data: {
			...
			"user" : "webmaster1@gmail.com",
			"Name" : "John Doe",
			"EmailAddress" : "webmaster1@gmail.com",
			"products" : [{
