...
.source('')
.destination('/var/www/html/websites/59db1335dd92ed001a69aae2/flowzwebsitefinal/public')
.clean(false)
.use(markdown())
.use(inPlace(true))
.use(layouts({engine:'handlebars',directory:'/var/www/html/websites/59db1335dd92ed001a69aae2/flowzwebsitefinal/Layout'}))
