...
$(document).on("click", ".smooth-scroll", function(event) { event.preventDefault();
                            ...
                            if (showItem) {
                                ...
                                $.ajax({
                                            ...
                                            Date.replaceChars = {
                                                ...
                                                T: function() { var m = this.getMonth();
                                                    this.setMonth(0); var result = this.toTimeString().replace(/^.+ \(?([^\)]+)\)?$/, '$1');
                                                    this.setMonth(m); return result; },
                                            ...
                                            $(document).ready(function() {
                                                window.$zopim || (function(d, s) {
                                                    ...
                                                    $.src = "https://v2.zopim.com/?5djwAvXR04Z6LOgDZK23L8hn7QXFldZY";
                                                    z.t = +new Date;
                                                    $.
