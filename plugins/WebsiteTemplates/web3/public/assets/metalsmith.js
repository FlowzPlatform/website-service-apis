...
.source('')
.destination('/var/www/html/websites/59db1335dd92ed001a69aae2/6e8c1bfd-3186-41e7-b360-d6a5c58ee48b/public')
.clean(false)
.use(markdown())
.use(inPlace(true))
.use(layouts({engine:'handlebars',directory:'/var/www/html/websites/59db1335dd92ed001a69aae2/6e8c1bfd-3186-41e7-b360-d6a5c58ee48b/Layout'}))
